    ...
    <div class="b-grid">
      <div class="b-grid__row">
        ...
        >
          ...
          <draggable v-model="$sectionData.components4" class="b-draggable-slot" :style="$sectionData.container4.styles" @change="dragStop">
      ...
      <div class="b-grid__row">
        ...
        <div class="b-grid__col-4 b-grid__col-m-12">
          <sandbox
            ...
            >
            <draggable v-model="$sectionData.components3" class="b-draggable-slot" :style="$sectionData.container3.styles" @change="dragStop">
