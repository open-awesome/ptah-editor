    ...
    <div class="b-grid__row">
      ...
      <div
        ...
        <sandbox
          ...
          <draggable v-model="$sectionData[`components${ prefix }`]" :style="$sectionData[`container${ prefix }`].styles" class="b-draggable-slot" @start="drag('components')" @change="dragStop">
